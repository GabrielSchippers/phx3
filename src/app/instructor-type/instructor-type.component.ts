...
@Component({
  selector: 'app-instructor-type',
  templateUrl: './instructor-type.component.html',
  providers: [WikipediaService],
  styleUrls: ['./instructor-type.component.scss']
})
export class InstructorTypeComponent implements OnInit {
